...
export const ActionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getVariablesInFlow: async (actionId: string, flowId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'actionId' is not null or undefined
            if (actionId === null || actionId === undefined) {
            ...
            // verify required parameter 'flowId' is not null or undefined
            if (flowId === null || flowId === undefined) {
                throw new RequiredError('flowId','Required parameter flowId was null or undefined when calling getVariablesInFlow.');
            }
            const localVarPath = `/action/{actionId}/flow/{flowId}/variables`
                .replace(`{${"actionId"}}`, encodeURIComponent(String(actionId)))
                .replace(`{${"flowId"}}`, encodeURIComponent(String(flowId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
...
export const ActionsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getVariablesInFlow(actionId: string, flowId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetVariablesInFlow>>> {
            const localVarAxiosArgs = await ActionsApiAxiosParamCreator(configuration).getVariablesInFlow(actionId, flowId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ActionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getVariablesInFlow(actionId: string, flowId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<GetVariablesInFlow>> {
            return ActionsApiFp(configuration).getVariablesInFlow(actionId, flowId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {ActionDto} body 
...
export class ActionsApi extends BaseAPI {
     ...
     * @memberof ActionsApi
     */
    public async getVariablesInFlow(actionId: string, flowId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<GetVariablesInFlow>> {
        return ActionsApiFp(this.configuration).getVariablesInFlow(actionId, flowId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {ActionDto} body 
