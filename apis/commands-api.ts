...
export const CommandsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getCommands: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CommandsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getCommands(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetCommandsList>>> {
            const localVarAxiosArgs = await CommandsApiAxiosParamCreator(configuration).getCommands(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CommandsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getCommands(options?: AxiosRequestConfig): Promise<AxiosResponse<GetCommandsList>> {
            return CommandsApiFp(configuration).getCommands(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {UpdateCommandDto} body 
...
export class CommandsApi extends BaseAPI {
     ...
     * @memberof CommandsApi
     */
    public async getCommands(options?: AxiosRequestConfig) : Promise<AxiosResponse<GetCommandsList>> {
