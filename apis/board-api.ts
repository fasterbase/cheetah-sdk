...
export const BoardApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getSimulate: async (deviceId: string, subDeviceId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'deviceId' is not null or undefined
            if (deviceId === null || deviceId === undefined) {
            ...
            if (subDeviceId === null || subDeviceId === undefined) {
                throw new RequiredError('subDeviceId','Required parameter subDeviceId was null or undefined when calling getSimulate.');
            }
            const localVarPath = `/board/simulate/{deviceId}/{subDeviceId}`
                .replace(`{${"deviceId"}}`, encodeURIComponent(String(deviceId)))
...
export const BoardApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getSimulate(deviceId: string, subDeviceId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetSimulate>>> {
            const localVarAxiosArgs = await BoardApiAxiosParamCreator(configuration).getSimulate(deviceId, subDeviceId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const BoardApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getSimulate(deviceId: string, subDeviceId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<GetSimulate>> {
            return BoardApiFp(configuration).getSimulate(deviceId, subDeviceId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} deviceId 
...
export class BoardApi extends BaseAPI {
     ...
     * @memberof BoardApi
     */
    public async getSimulate(deviceId: string, subDeviceId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<GetSimulate>> {
        return BoardApiFp(this.configuration).getSimulate(deviceId, subDeviceId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {string} deviceId 
